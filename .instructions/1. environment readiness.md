...
1. Navigate to the [Copilot-node-restapi repo](https://github.com/GitHub-Enovade-Lab/copilot-node-restapi.git) 
...
<img alt="URL for cloning is https://github.com/copilot-workshops/copilot-node-calculator.git" width="400" src="../assets/clone-repo.png" />
...
<img width="601" alt="Open in a Codespace" src="../assets/open-codespaces.png">
